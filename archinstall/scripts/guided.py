...
def perform_installation(mountpoint: Path):
    ...
    with Installer(
        ...
        if archinstall.arguments.get("swap") is not None:
            print("@@@@@@@", archinstall.arguments["swap"])
            installation.setup_swap(archinstall.arguments["swap"])
        ...
        network_config: Optional[NetworkConfiguration] = archinstall.arguments.get(
            "network_config", None
        )
        ...
        audio_config: Optional[AudioConfiguration] = archinstall.arguments.get(
            "audio_config", None
        )
        if audio_config:
